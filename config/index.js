...
module.exports = {
  dev: {
    ...
    proxyTable: {
      '/api': {
        target: 'https://carapptest.gtmc.com.cn', // 你请求的第三方接口
  ...
  build: {
    ...
    index: path.resolve(__dirname, '../gtmcAppH5/index.html'),

    // Paths
    assetsRoot: path.resolve(__dirname, '../gtmcAppH5'),
    assetsSubDirectory: 'static',
    assetsPublicPath: '/gtmcAppH5/',
    publicPath: "/gtmcAppH5/",
    /**
     * Source Maps
     */
